sources_oceanographic <- function() {
    bind_rows(
        ...
        bb_source(
            ...
            method=quote(bb_wget),
            method_flags=c("--recursive","--no-parent","-e","robots=off","--reject=index.html*"),
            postprocess=NULL,
            collection_size=6.0,
            data_group="Oceanographic"),
        bb_source(
            ...
            method=quote(bb_wget),
            method_flags=c("--recursive","--no-parent","-e","robots=off","--reject=index.html*","--reject-regex","/(ascii|csv|shape|5564|6574|7584|8594|95A4|A5B2)/"),
