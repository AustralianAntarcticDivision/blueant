sources_seaice <- function() {
    bind_rows(
        bb_source(
            ...
            method_flags=c("--exclude-directories=pub/DATASETS/nsidc0051_gsfc_nasateam_seaice/final-gsfc/browse","--recursive","--level=6"),
            postprocess=NULL,
        ...
        bb_source(
            ...
            license="Please cite, see http://nsidc.org/about/use_copyright.html",
            method=quote(bb_handler_wget),
            method_flags=c("--exclude-directories=pub/DATASETS/nsidc0081_nrt_nasateam_seaice/browse","--recursive","--level=3"),
            postprocess=NULL,
            access_function="readice",
            collection_size=0.6,
            data_group="Sea ice"),
        bb_source(
            ...
            license="Please cite, see http://nsidc.org/about/use_copyright.html",
            method=quote(bb_handler_wget),
            method_flags=c("--recursive","--level=3"),
            postprocess=NULL,
            access_function="readice",
            collection_size=0.1,
            data_group="Sea ice"),
        bb_source(
            ...
            method_flags=c("--recursive","--level=2","--no-parent","--relative"),##,"--accept-regex=/NmIcEdg2.001/"),
            user="",
            password="",
            postprocess=NULL,
            collection_size=0.1,
        ...
        bb_source(
            ...
            license="Please cite",
            method=quote(bb_handler_wget),
            method_flags=c("--recursive","--level=4","--follow-ftp"),
        ...
        bb_source(
            ...
            license="Please cite",
            method=quote(bb_handler_wget),
            method_flags=c("--recursive","--level=2","--follow-ftp"),
            postprocess=NULL,
            access_function="readice",
        ...
        bb_source(
            ...
            license="Please cite",
            method=quote(bb_handler_wget),
            method_flags=c("--recursive","--level=5","--accept=asi*.hdf","--accept=asi*.png","--accept=asi*.tif","--no-parent"),
            postprocess=NULL,
            access_function="readice",
            collection_size=11,
            data_group="Sea ice"),
        bb_source(
            ...
            reference="https://seaice.uni-bremen.de/regional/",
            citation="Spreen, G., L. Kaleschke, and G. Heygster (2008), Sea ice remote sensing using AMSR-E 89 GHz channels, J. Geophys. Res. 113, C02S03, doi:10.1029/2005JC003384",
            source_url="https://seaice.uni-bremen.de/data/amsr2/asi_daygrid_swath/s3125/",
            license="Please cite",
            method=quote(bb_handler_wget),
            method_flags=c("--recursive","--level=5","--accept=asi*.hdf","--accept=asi*.tif","--accept=asi*.png","--no-parent"),
            postprocess=NULL,
            access_function="readice",
        ...
        bb_source(
            ...
            license="Not known",
            method=quote(bb_handler_wget),
            method_flags=c("--accept=*.kmz","--recursive","--level=1"),
            data_group="Sea ice")
    )
}
