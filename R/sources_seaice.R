sources_seaice <- function() {
    bind_rows(
        ...
        bb_source(
            ...
            method=quote(bb_handler_wget),
            method_flags=c("--recursive","--level=5","--accept=asi*.hdf","--accept=asi*.png","--accept=asi*.tif","--reject-regex=^/amsr2data/","--no-parent"),
            postprocess=NULL,
            access_function="readice",
            collection_size=11,
            data_group="Sea ice"),
        bb_source(
            ...
            comment="--reject-regex=\"^/amsr2data/\" to prevent download from recursing into unwanted directories",
            method=quote(bb_handler_wget),
            method_flags=c("--recursive","--level=5","--accept=asi*.hdf","--accept=asi*.tif","--accept=asi*.png","--reject-regex=^/amsr2data/","--no-parent"),
            postprocess=NULL,
            access_function="readice",
        ...
        bb_source(
            ...
            license="Please cite",
            method=quote(bb_handler_wget),
            method_flags=c("--recursive","--level=1","--accept=hdf","--no-parent"),
            postprocess=NULL,
