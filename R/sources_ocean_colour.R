    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata MODIS Aqua Level-3 mapped daily 4km chl-a","MODISA_L3m_DAY_CHL_chlor_a_4km")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata",search="A*L3m_DAY_CHL_chlor_a_4km.nc", sensor = "aqua", dtype = "L3m"),
    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata MODIS Aqua Level-3 mapped monthly 9km chl-a","MODISA_L3m_MO_CHL_chlor_a_9km")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata",search="A*L3m_MO_CHL_chlor_a_9km.nc", sensor = "aqua", dtype = "L3m"),
    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata VIIRS Level-3 mapped daily 4km chl-a","VIIRS_L3m_DAY_NPP_CHL_chlor_a_4km")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata",search="V2016*L3m_DAY_NPP_CHL_chlor_a_4km.nc", sensor = "viirs", dtype = "L3m"),
    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata VIIRS Level-3 mapped monthly 9km chl-a","VIIRS_L3m_MO_SNPP_CHL_chlor_a_9km")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata",search="V*L3m_MO_SNPP_CHL_chlor_a_9km.nc", sensor = "viirs", dtype = "L3m"),
                         ##method=list("bb_handler_oceandata", search = "https://oceandata.sci.gsfc.nasa.gov/VIIRS-SNPP/Mapped/Daily/4km/chlor_a/", search_method = "scrape"),
                         postprocess=NULL,
                         collection_size=1,
                         user = "", password = "", warn_empty_auth = FALSE,
    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata VIIRS Level-3 mapped seasonal 9km chl-a","VIIRS_L3m_SNxx_SNPP_CHL_chlor_a_9km")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata",search="V*L3m_SN*_SNPP_CHL_chlor_a_9km.nc", sensor = "viirs", dtype = "L3m"),
    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata VIIRS Level-3 binned daily RRS","VIIRS_L3b_DAY_SNPP_RRS")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata", search = "V*L3b_DAY_SNPP_RRS.nc", sensor = "viirs", dtype = "L3b"),
    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata MODIS Aqua Level-3 binned daily RRS","MODISA_L3b_DAY_RRS")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata",search="A*L3b_DAY_RRS.nc", sensor = "aqua", dtype = "L3b"),
                         ## scrape method will be super slow because of recursion
    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata SeaWiFS Level-3 binned daily RRS","SeaWiFS_L3b_DAY_RRS")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata",search="S*L3b_DAY_RRS.nc", sensor = "seawifs", dtype = "L3b"),
                         ## scrape method will be super slow because of recursion
    ...
    if (is.null(name) || any(name %in% tolower(c("Oceandata VIIRS Level-3 mapped 32-day 9km chl-a","VIIRS_L3m_R32_SNPP_CHL_chlor_a_9km")))) {
        out <- rbind(out,
                     bb_source(
                         ...
                         citation="See https://oceancolor.gsfc.nasa.gov/citations",
                         license="Please cite",
                         method=list("bb_handler_oceandata",search="V*L3m_R32_SNPP_CHL_chlor_a_9km.nc", sensor = "viirs", dtype = "L3m"),
