sources_ocean_colour <- function() {
    bind_rows(
        ...
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=A*L3m_DAY_CHL_chlor_a_4km.nc"),
            postprocess=NULL,
            collection_size=40,
            data_group="Ocean colour"),
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=A*L3m_MO_CHL_chlor_a_9km.nc"),
            postprocess=NULL,
            collection_size=8,
            data_group="Ocean colour"),
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=V2016*L3m_DAY_NPP_CHL_chlor_a_4km.nc"),
            postprocess=NULL,
            collection_size=1,
            data_group="Ocean colour"),
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=V*L3m_MO_SNPP_CHL_chlor_a_9km.nc"),
            postprocess=NULL,
            collection_size=1,
            data_group="Ocean colour"),
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=V*L3m_SN*_SNPP_CHL_chlor_a_9km.nc"),
            postprocess=NULL,
            collection_size=0.5,
            data_group="Ocean colour"),
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=V*L3b_DAY_SNPP_RRS.nc"),
            postprocess=NULL,
        ...
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=A*L3b_DAY_RRS.nc"),
            postprocess=NULL,
            access_function="roc::readL3",
            collection_size=800,
            data_group="Ocean colour"),
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=S*L3b_DAY_RRS.nc"),
            postprocess=NULL,
            access_function="roc::readL3",
            collection_size=130,
            data_group="Ocean colour"),
        bb_source(
            ...
            license="Please cite",
            method=quote(oceandata_get),
            method_flags=c("search=V*L3m_R32_SNPP_CHL_chlor_a_9km.nc"),
            postprocess=NULL,
            collection_size=4,
            data_group="Ocean colour")
    )
