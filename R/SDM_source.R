...
#'    \item nb_extreme_event_max_sali_2005_2012_nb Number of extreme events (maximal seafloor salinity records) that happened between January and December of the year  
#'    \item nb_extreme_event_min_sali_2005_2012_nb Number of extreme events (minimal seafloor salinity records) that happened between January and December of the year  
