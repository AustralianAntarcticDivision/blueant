...
[![Travis-CI Build
Status](https://travis-ci.org/AustralianAntarcticDivision/blueant.svg?branch=master)](https://travis-ci.org/AustralianAntarcticDivision/blueant)
[![AppVeyor Build
status](https://ci.appveyor.com/api/projects/status/5idrimyx0uuv6liu?svg=true)](https://ci.appveyor.com/project/raymondben/blueant)
...
## --------------------------------------------------------------------------------------------
## 
##  this dataset path is: /tmp/RtmpjAqcVC/data.aad.gov.au/eds/file/4494
...
## [1] "/tmp/RtmpjAqcVC/data.aad.gov.au/eds/file/4494/"
```
...
## [1] "/tmp/RtmpjAqcVC/data.aad.gov.au/eds/file/4494//download.zip"    
## [2] "/tmp/RtmpjAqcVC/data.aad.gov.au/eds/file/4494//gvdem1000m_v3.nc"
## [3] "/tmp/RtmpjAqcVC/data.aad.gov.au/eds/file/4494//gvdem100m_v3.nc" 
## [4] "/tmp/RtmpjAqcVC/data.aad.gov.au/eds/file/4494//gvdem250m_v3.nc" 
## [5] "/tmp/RtmpjAqcVC/data.aad.gov.au/eds/file/4494//gvdem500m_v3.nc"
```
...
sources, you will need to provide your user name and password,
e.g.:
...
concentration at 3.125km spatial resolution in selected regions (from
24-July-2012 to present) and full Antarctic coverage (from 1-Jan-2016 to
present).
...
Documentation link:
<https://data.aad.gov.au/metadata/records/modis_20day_fast_ice>
...
Documentation link:
<http://www.ga.gov.au/metadata-gateway/metadata/record/gcat_71552>
