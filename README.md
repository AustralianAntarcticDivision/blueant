...
Add data sources from those provided by blueant. A summary of these sources is given at the end of this document. Here we'll use the "George V bathymetry" data source as an example, because it's fairly small:

``` r
cf <- cf %>% bb_add(sources("George V bathymetry"))
```
